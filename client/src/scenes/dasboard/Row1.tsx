...
import { AreaChart, XAxis, YAxis,BarChart,Bar,Line, Area, Tooltip, ResponsiveContainer, CartesianGrid, Legend, LineChart } from 'recharts';
  ...
  return (
    <>
      ...
      <BoxHeader
        ...
        ></BoxHeader>
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={revenueProfit} margin={{ top: 20, right: 0, left: -10, bottom: 55 }}>
